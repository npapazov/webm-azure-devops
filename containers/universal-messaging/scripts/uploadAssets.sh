...
touch /opt/softwareag/UniversalMessaging/server/umserver/bis
rm -rf /opt/softwareag/UniversalMessaging/server/umserver/data/heap_dumps
ls -la /opt/softwareag/UniversalMessaging/server/umserver/data/
